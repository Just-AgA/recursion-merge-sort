...
console.log(
  `Sorted array for [38, 27, 43, 3, 9, 82, 10] is ${mergeSort([
    38, 27, 43, 3, 9, 82, 10,
  ])}`
);
console.log(
  `Sorted array for [3, 2, 1, 13, 8, 5, 0, 1] is ${mergeSort([
    3, 2, 1, 13, 8, 5, 0, 1,
  ])}`
);
console.log(
  `Sorted array for [105, 79, 100, 110] is ${mergeSort([105, 79, 100, 110])}`
);
